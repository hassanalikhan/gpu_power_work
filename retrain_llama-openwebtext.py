...
def retrain_tiny_llama(
        ...
        # Reduce dataset to 1/5th size
        total_size = len(train_dataset)
        reduced_size = total_size // 5
        print(f"Reducing dataset from {total_size} to {reduced_size} samples.")
        train_dataset = train_dataset.shuffle(seed=42).select(range(reduced_size))
...
if __name__ == "__main__":
        ...
        retrain_tiny_llama(model_name="TinyLlama/TinyLlama-1.1B-Chat-v1.0", dataset_name="openwebtext")
